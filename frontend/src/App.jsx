...
const SIDEBAR_SERVICES = [
  ...
  { id:"counselling",label:"Complete Personalised Counselling",   icon:"🤝", free:false, panel:"paid" },
  ...
  return (
    <div>
      ...
      <FadeIn delay={0.1} direction="up"><div style={s.card}>
        ...
        {/* Optional filters — always visible, no toggle */}
        <div style={s.filterBox}>
          <div style={{ ...s.filterToggle, cursor:"default", pointerEvents:"none" }}>
